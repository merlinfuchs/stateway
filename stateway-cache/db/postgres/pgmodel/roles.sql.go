...
type DeleteGuildRolesParams struct {
	AppID   int64
	GuildID int64
}

func (q *Queries) DeleteGuildRoles(ctx context.Context, arg DeleteGuildRolesParams) error {
	_, err := q.db.Exec(ctx, deleteGuildRoles, arg.AppID, arg.GuildID)
	return err
}
