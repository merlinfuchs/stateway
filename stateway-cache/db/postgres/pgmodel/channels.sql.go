...
type DeleteGuildChannelsParams struct {
	AppID   int64
	GuildID int64
}

func (q *Queries) DeleteGuildChannels(ctx context.Context, arg DeleteGuildChannelsParams) error {
	_, err := q.db.Exec(ctx, deleteGuildChannels, arg.AppID, arg.GuildID)
	return err
}
